...
<html>
    ...
    <body>
        <form action="nataslevel5.php" method="post">
            ...
            <div class="container-fluid">    
                <div class="row content">
                    ...
                    <div class="col-sm-8 text-center"> 
                        ...
                        <p>
                            The username is natas5.
                            The password is in a secret directory. 
                            Hint: The directory "Files" is possible. You figure it out. 
                        </p>
                    </div>
